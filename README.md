...
### methods
#### CameraVapix(options)
Options parameter contains access to the camera, service name and service ID. If service ID is not specified, service is automatically created in CamOverlay.
```javascript
options = {
  'ip': '127.0.0.1',
  'port': 80,
